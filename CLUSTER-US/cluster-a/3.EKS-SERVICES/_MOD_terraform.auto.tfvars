s3_key_eks_data = "us-east-1/thoth-production/eks-core-a/terraform.tfstate"
s3_key_vpc_data = "us-east-1/thoth-production/vpc-a/terraform.tfstate"
...
studio_cilium_policy = {
  service_account_name = "studio-us-prod-ciliumnetworkpolicies"
  namespace            = "default"
}

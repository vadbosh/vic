...
module "cert_manager" {
  ...
  chart_version                          = local.cert_manager_version
  ...
  additional_set = [
    ...
    },
    {
      ...
      value = "${data.terraform_remote_state.eks_core.outputs.nodegroup_prefix}-metrics"
    },
    {
  ...
  certificates = {
    "wellnessliving-com" = {
      secret_annotations = {
        ...
        "reflector.v1.k8s.emberstack.com/reflection-allowed-namespaces" = "default,thoth-production,backup"
      }
      dns_names   = ["*.wellnessliving.com", "wellnessliving.com", "*.ms.thoth.wellnessliving.com", "*.au-thoth.wellnessliving.com"]
      namespace   = "default"

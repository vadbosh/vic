...
| Name | Type |
|------|------|
| [aws_efs_backup_policy.victoria](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/efs_backup_policy) | resource |
| [aws_efs_file_system.victoria_fs](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/efs_file_system) | resource |
| [aws_efs_mount_target.victoria](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/efs_mount_target) | resource |
...
| [aws_lb.ssh_nlb](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb) | resource |
...
| <a name="output_ssh_nlb_arn"></a> [ssh\_nlb\_arn](#output\_ssh\_nlb\_arn) | ARN of the created SSH Network Load Balancer. |
| <a name="output_ssh_nlb_dns_name"></a> [ssh\_nlb\_dns\_name](#output\_ssh\_nlb\_dns\_name) | DNS name of the created SSH Network Load Balancer. |
| <a name="output_ssh_nlb_name"></a> [ssh\_nlb\_name](#output\_ssh\_nlb\_name) | name of the created SSH Network Load Balancer. |
<!-- END_TF_DOCS -->